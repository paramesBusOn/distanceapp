...
//   void onLocationUpdate(LocationDto dto)async {
//     print("test2::"+dtoToString(dto));
//      await LocationManager().start();
...
//         entry(
//             "Stops",
//             _mobilityContext == null ? '' : "${_mobilityContext!.stops.length}",
//             stopIcon),
//         entry(
//             "Moves",
//             _mobilityContext == null ? '' : "${_mobilityContext!.moves.length}",
//             moveIcon),
//         entry(
//             "Significant Places",
